function depth = off2im(offfile, ratio, xzRot, xyRot, tilt, objz, objx)
...
% error handling code added by yan
if isempty(maxDepth); 
    fprintf('maxdepth = 0 for %s.\n', offfile); 
    depth = 0;
    return; 
end;
...
function R = genRotMat(theta, phi)
